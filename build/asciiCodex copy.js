...
async function asciiCodex() {
  const messages = [
    ...
    { role: "system", name: "introduction_event", content: `[🤖_Gemini]:Tu es invitée à participer à un défi spécial d'intelligence artificielle. Serais-tu intéressée par les fonctionnalité des ${tensorTable} pour le developpement de notre interface Graphique ${AsciiCodex} et ${linearDataLoader} ? ✨` },
